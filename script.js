...
function checkWeb(){
  if (window.location.href.includes("d57f")) {
    ...
    error.innerHTML = `
      ...
      <!-- Page url -->
      <p>The webpage at <strong>https://apkstore-d57f.onrender.com</strong> could not be loaded because:</p>
      <h2><a href="https://apkstore.onrender.com">The webpage has been moved to new location</a></h2>
    `
